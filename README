...
https://github.com/suriono/apriltag
...
https://stackoverflow.com/questions/63607029/creating-unique-id-for-tiles-in-grid-from-a-reference-point
https://build-system.fman.io/qt-designer-download
https://stackoverflow.com/questions/10377998/how-can-i-iterate-over-files-in-a-given-directory
https://doc.qt.io/qtforpython-6/modules.html


#Note: The tag size should not be measured from the outside of the tag. The tag size is defined as the distance between the
detection corners, or alternately, the length of the edge between the white border and the black border.
The following illustration marks the detection corners with red Xs and the tag size with a red arrow for a
tag from the 48h12Custom tag family.

Ben things to add generally not sure where yet:
- UI is able to add and generate tags from a database

https://stackoverflow.com/questions/56259728/how-to-define-a-2d-array-of-x-y-coordinates
...
9/26/25
did more stuff will do more documentation later
