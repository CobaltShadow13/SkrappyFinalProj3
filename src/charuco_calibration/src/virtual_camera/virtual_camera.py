...
class VirtualCamera:
    ...
    This class provides basic functionality for loading data and creating masks.
    """
...
class RectangularCamera(VirtualCamera):
    """
    A virtual camera that splits data into rectangular sections.
    """
...
class ConcentricCamera(VirtualCamera):
    """
    A virtual camera that splits data into concentric circular sections.
    """
